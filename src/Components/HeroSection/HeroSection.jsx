...
const HeroSection = () => {
  ...
  useEffect(() => {
    if (window.innerWidth < 600) return; // Don't run the effect if screen size is less than 600
    ...
    return () => {
      animation.kill(); // Clean up the animation on unmount or when the effect is re-run
    };
  }, []);
  ...
  return (
    <div className="HeroSection" ref={containerRef}>
      <div className="hero_section_widgets" ref={divRef}>
        <img
          className="profitability_img"
          src="/assets/LandingPage/HeroElements/profitability.svg"
          alt=""
        />
        <img
          className="revenue_img"
          src="/assets/LandingPage/HeroElements/revenue.png"
          alt=""
        />
        <img
          className="totalAssets_img"
          src="/assets/LandingPage/HeroElements/total assets.svg"
          alt=""
        />
        <img
          className="cashflow_img"
          src="/assets/LandingPage/HeroElements/Cash Flow.svg"
          alt=""
        />
      </div>
      ...
      <div className="resp_hero_section_widgets">
        <Marquee autoFill={true}>
          <img
            className="profitability_img"
            src="/assets/LandingPage/HeroElements/respProfitability.svg"
            alt=""
          />
          <img
            className="revenue_img"
            src="/assets/LandingPage/HeroElements/respRevenue.png"
            alt=""
          />
          <img
            className="totalAssets_img"
            src="/assets/LandingPage/HeroElements/respTotalAssets.svg"
            alt=""
          />
          <img
            className="cashflow_img"
            src="/assets/LandingPage/HeroElements/respCashflow.svg"
            alt=""
          />
        </Marquee>
      </div>
      ...
      <div className="hero_section_description" ref={heroRef}>
        ...
        <div className="hero_section_action_btns">
          ...
          <Button
            className={"schedule_call"}
            name={"Know dayX better"}
            onClick={handlePopup}
          />
      ...
      <div className="hero_section_advantages">
        <div className="hero_section_advantages_container">
          <div className="advantages_card">
            <h1>90%</h1>
            <p>
              Faster Financial <br /> Month Close
            </p>
          </div>
